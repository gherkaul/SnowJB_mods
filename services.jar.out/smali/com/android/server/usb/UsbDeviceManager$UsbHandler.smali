...
.method private setAdbEnabled(Z)V
    ...
    invoke-interface {v0}, Lcom/lge/cappuccino/IMdm;->checkDisabledUsbDebug()Z
...
.method private setEnabledFunctions(Ljava/lang/String;Z)V
    ...
    .line 628
    const-string v2, "persist.sys.usb.config.extra"
    ...
    const-string v4, "sys/devices/platform/lg_diag_cmd/diag_enable"

    #calls: Lcom/android/server/usb/UsbDeviceManager;->readFromFile(Ljava/lang/String;)Ljava/lang/String;
    invoke-static {v3, v4}, Lcom/android/server/usb/UsbDeviceManager;->access$1600(Lcom/android/server/usb/UsbDeviceManager;Ljava/lang/String;)Ljava/lang/String;
    ...
    #setter for: Lcom/android/server/usb/UsbDeviceManager;->mDiag:Z
    ...
    invoke-interface {v2, v3, v4}, Lcom/lge/cappuccino/IMdm;->checkDisabledSystemService(Landroid/content/ComponentName;Ljava/lang/String;)Z
    ...
    #getter for: Lcom/android/server/usb/UsbDeviceManager;->mDiag:Z
    ...
    #calls: Lcom/android/server/usb/UsbDeviceManager;->addFunction(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    invoke-static {p1, v2}, Lcom/android/server/usb/UsbDeviceManager;->access$1700(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v3, "cdrom_storage,adb"
    ...
    invoke-static {p1, v2}, Lcom/android/server/usb/UsbDeviceManager;->access$1900(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-interface {v2}, Lcom/lge/cappuccino/IMdm;->checkDisabledUsbDebug()Z
    ...
    const-string v4, "MDM block adb function"
    ...
    invoke-interface {v2, v3}, Lcom/lge/cappuccino/IMdm;->restoreUsbFunctionExceptAdb(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    .line 704
    .local v1, mdmFunctions:Ljava/lang/String;
    const-string v2, "persist.sys.usb.config"
    ...
    .line 710
    .end local v1           #mdmFunctions:Ljava/lang/String;
    :cond_b
    const-string v2, "persist.sys.usb.config"
    ...
    #calls: Lcom/android/server/usb/UsbDeviceManager;->processOemUsbOverride(Ljava/lang/String;)Ljava/lang/String;
    invoke-static {v2, p1}, Lcom/android/server/usb/UsbDeviceManager;->access$400(Lcom/android/server/usb/UsbDeviceManager;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 744
    .restart local v1       #mdmFunctions:Ljava/lang/String;
...
.method private updateCurrentAccessory()V
    ...
    #calls: Lcom/android/server/usb/UsbDeviceManager;->removeFunction(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    invoke-static {v0, v1}, Lcom/android/server/usb/UsbDeviceManager;->access$1900(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method private updateUsbNotification()V
    ...
    #getter for: Lcom/android/server/usb/UsbDeviceManager;->mNotificationManager:Landroid/app/NotificationManager;
    invoke-static {v10}, Lcom/android/server/usb/UsbDeviceManager;->access$2600(Lcom/android/server/usb/UsbDeviceManager;)Landroid/app/NotificationManager;
    ...
    iget v11, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mUsbNotificationId:I

    invoke-virtual {v10, v11}, Landroid/app/NotificationManager;->cancel(I)V

    .line 1050
    iput v13, p0, Lcom/android/server/usb/UsbDeviceManager$UsbHandler;->mUsbNotificationId:I
    ...
    iput-wide v10, v5, Landroid/app/Notification;->when:J
    ...
    .line 1072
    const-string v10, "ro.factorytest"
    ...
    const-string v11, "usb_connected_sound"
    ...
    :cond_5
    :goto_2
    iput-object v14, v5, Landroid/app/Notification;->vibrate:[J

    .line 1088
    const/4 v10, -0x1

    iput v10, v5, Landroid/app/Notification;->priority:I
    ...
    const-string v12, "com.android.settings.Settings$ConnectivitySettingsActivity"
    ...
    invoke-static {v10, v13, v3, v13}, Landroid/app/PendingIntent;->getActivity(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
    ...
    invoke-virtual {v5, v10, v9, v4, v6}, Landroid/app/Notification;->setLatestEventInfo(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Landroid/app/PendingIntent;)V
    ...
    invoke-virtual {v10, v1, v5}, Landroid/app/NotificationManager;->notify(ILandroid/app/Notification;)V
    ...
    const-string v11, "cdrom_storage"
    ...
    const-string v11, "No known USB function in updateUsbNotification"
    ...
    .line 1081
    iput-object v14, v5, Landroid/app/Notification;->sound:Landroid/net/Uri;
    ...
    const-string v12, "com.android.settings.Settings$TetherSettingsActivity"
    ...
    const-string v12, "com.android.settings.UsbSettings"
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 840
    .local v3, mAutorunEnabledMdmBackup:Z
    invoke-static {}, Lcom/lge/cappuccino/Mdm;->getInstance()Lcom/lge/cappuccino/IMdm;
    ...
    const-string v10, "LGMDMUsbUIAdapter"

    invoke-interface {v7, v13, v10}, Lcom/lge/cappuccino/IMdm;->checkDisabledSystemService(Landroid/content/ComponentName;Ljava/lang/String;)Z
    ...
    const-string v8, "Usb handleMessage : MDM Block"
    ...
    const-string v8, "LGMDMUsbUIAdapter"

    invoke-interface {v7, v13, v8}, Lcom/lge/cappuccino/IMdm;->checkDisabledSystemService(Landroid/content/ComponentName;Ljava/lang/String;)Z
    ...
    #setter for: Lcom/android/server/usb/UsbDeviceManager;->mAutorunEnabled:Z
    invoke-static {v7, v3}, Lcom/android/server/usb/UsbDeviceManager;->access$1002(Lcom/android/server/usb/UsbDeviceManager;Z)Z
    ...
    #calls: Lcom/android/server/usb/UsbDeviceManager;->removeFunction(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    invoke-static {v7, v8}, Lcom/android/server/usb/UsbDeviceManager;->access$1900(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    #calls: Lcom/android/server/usb/UsbDeviceManager;->removeFunction(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    invoke-static {v1, v7}, Lcom/android/server/usb/UsbDeviceManager;->access$1900(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    #getter for: Lcom/android/server/usb/UsbDeviceManager;->mSettingsManager:Lcom/android/server/usb/UsbSettingsManager;
    invoke-static {v7}, Lcom/android/server/usb/UsbDeviceManager;->access$2400(Lcom/android/server/usb/UsbDeviceManager;)Lcom/android/server/usb/UsbSettingsManager;
    ...
    invoke-virtual {v7, v10}, Lcom/android/server/usb/UsbSettingsManager;->accessoryAttached(Landroid/hardware/usb/UsbAccessory;)V
    ...
    invoke-static {v7, v8}, Lcom/android/server/usb/UsbDeviceManager;->access$1102(Lcom/android/server/usb/UsbDeviceManager;Z)Z
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0

    .line 955
    .end local v2           #isProvisioned:Z
    .end local v4           #mComponentState:I
    ...
    .restart local v4       #mComponentState:I
    ...
    const-string v8, "error is ocurred when check getApplicationEnabledSetting"
