...
.field static final MOVE_TO_BACK_MSG:I = 0x6e

.field static final OVERLAY_RESUME_TOP_ACTIVITY_MSG:I = 0x70
...
.field static final SHOW_AlREADY_RUNNING_MSG:I = 0x6f
...
.field mInChangingFocusToOverlay:Z
...
.method constructor <init>(Lcom/android/server/am/ActivityManagerService;Landroid/content/Context;Z)V
    ...
    .line 307
    iput-boolean v3, p0, Lcom/android/server/am/ActivityStack;->mInChangingFocusToOverlay:Z
...
.method private findOverlayActivity()Lcom/android/server/am/ActivityRecord;
    .locals 5
    ...
    iget-boolean v3, v1, Lcom/android/server/am/ActivityRecord;->isTopOverlay:Z
    ...
    const-string v4, "findOverlayActivity, "
...
.method private findSamePackageInOverlayTask(Ljava/lang/String;)Z
    .locals 14
    .parameter "startingPackageName"
    ...
    .line 5172
    .local v10, topTaskRealActivityName:Ljava/lang/String;
    const/4 v6, 0x0

    .line 5174
    .local v6, skipFirstSamePackage:Z
    iget-object v11, p0, Lcom/android/server/am/ActivityStack;->mHistory:Ljava/util/ArrayList;
    ...
    .line 5178
    :cond_0
    iget-boolean v11, v5, Lcom/android/server/am/ActivityRecord;->isTopOverlay:Z
    ...
    iget v9, v11, Lcom/android/server/am/TaskRecord;->taskId:I
    ...
    iget-object v11, v11, Lcom/android/server/am/TaskRecord;->realActivity:Landroid/content/ComponentName;
    ...
    iget-object v11, v4, Lcom/android/server/am/ActivityRecord;->packageName:Ljava/lang/String;
    ...
    const-string v13, "findSamePackageInOverlayTask, found:"
    ...
    .line 5197
    .local v7, spn:Lcom/android/server/am/ActivityRecord;
    ...
    const-string v12, "findSamePackageInOverlayTask, not found: arrived at HomeActivity"
    ...
    iget-object v12, v7, Lcom/android/server/am/ActivityRecord;->task:Lcom/android/server/am/TaskRecord;
    ...
    .line 5216
    .end local v7           #spn:Lcom/android/server/am/ActivityRecord;
    :cond_9
    const-string v11, "ActivityManager"
    ...
    const-string v13, "findSamePackageInOverlayTask, not found:"
...
.method private findSameTasksWithOverlay()Ljava/util/List;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 5143
    .local v5, topTaskID:I
    new-instance v4, Ljava/util/ArrayList;

    invoke-direct {v4}, Ljava/util/ArrayList;-><init>()V

    .line 5145
    .local v4, retList:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/server/am/ActivityRecord;>;"
    iget-object v6, p0, Lcom/android/server/am/ActivityStack;->mHistory:Ljava/util/ArrayList;
    ...
    .line 5149
    :cond_1
    iget-boolean v6, v3, Lcom/android/server/am/ActivityRecord;->isTopOverlay:Z
    ...
    iget v5, v6, Lcom/android/server/am/TaskRecord;->taskId:I
...
.method private isSecondTaskSamePackage()I
    .locals 10
    ...
    .line 5224
    .local v7, topTaskID:I
    invoke-direct {p0}, Lcom/android/server/am/ActivityStack;->findSameTasksWithOverlay()Ljava/util/List;

    move-result-object v0

    .line 5226
    .local v0, historyLists:Ljava/util/List;,"Ljava/util/List<Lcom/android/server/am/ActivityRecord;>;"
    move v3, v1
    ...
    .line 5228
    .local v5, p:Lcom/android/server/am/ActivityRecord;
    ...
    .end local v5           #p:Lcom/android/server/am/ActivityRecord;
    :goto_1
    return v8

    .line 5226
    .restart local v5       #p:Lcom/android/server/am/ActivityRecord;
    :cond_1
    add-int/lit8 v3, v3, -0x1
...
.method private isTopOverlayActivity()Z
    .locals 6
    ...
    iget-boolean v4, p0, Lcom/android/server/am/ActivityStack;->mInChangingFocusToOverlay:Z
    ...
    .line 5067
    .local v1, p:Lcom/android/server/am/ActivityRecord;
    iget-boolean v4, v1, Lcom/android/server/am/ActivityRecord;->isTopOverlay:Z
...
.method private final startActivityLocked(Lcom/android/server/am/ActivityRecord;ZZZLandroid/os/Bundle;)V
    ...
    .line 1943
    .local v4, addPos:I
    invoke-direct/range {p0 .. p0}, Lcom/android/server/am/ActivityStack;->isTopOverlayActivity()Z
    ...
    .line 1944
    invoke-virtual/range {p0 .. p0}, Lcom/android/server/am/ActivityStack;->getPositionOverlayNextTaskTopActivity()I
    ...
    const-string v5, "com.lge.QuickClip.QuickClipActivity"
    ...
    invoke-virtual {v3, v5}, Lcom/android/server/am/ActivityManagerService;->disableOverlayForMediaPlayer(Z)V
...
.method private final startPausingLocked(ZZ)V
    ...
    invoke-interface {v5, v6, v7, p1, v8}, Landroid/app/IApplicationThread;->schedulePauseActivity(Landroid/os/IBinder;ZZI)V
...
.method private final stopActivityLocked(Lcom/android/server/am/ActivityRecord;)V
    ...
    .line 3609
    invoke-virtual {p0}, Lcom/android/server/am/ActivityStack;->getMultiWindowFlag()Z
    ...
    invoke-virtual {v3, v4}, Lcom/android/server/wm/WindowManagerService;->getExternalWindowStatus(Landroid/os/IBinder;)I
    :try_end_0
    ...
    .line 3612
    .local v1, externalWindowStatus:I
    and-int/lit8 v3, v1, 0x1

    if-eqz v3, :cond_1

    .line 3679
    .end local v1           #externalWindowStatus:I
    :cond_0
    :goto_0
    return-void

    .line 3615
    .restart local v1       #externalWindowStatus:I
    :cond_1
    ...
    invoke-virtual {p0, v3, v7, v6, v4}, Lcom/android/server/am/ActivityStack;->requestFinishActivityLocked(Landroid/os/IBinder;ILandroid/content/Intent;Ljava/lang/String;)Z
    ...
    invoke-interface {v3, v4, v5, v6}, Landroid/app/IApplicationThread;->scheduleStopActivity(Landroid/os/IBinder;ZI)V
    ...
    invoke-virtual {p1, v3}, Lcom/android/server/am/ActivityRecord;->setSleeping(Z)V
    ...
    .line 3675
    const-string v3, "stop-except"

    invoke-virtual {p0, p1, v8, v7, v3}, Lcom/android/server/am/ActivityStack;->destroyActivityLocked(Lcom/android/server/am/ActivityRecord;ZZLjava/lang/String;)Z
    ...
    const-string v5, "[DSDR] Exception thrown - stopActivityLocked(): "
...
.method final activityIdleInternal(Landroid/os/IBinder;ZLandroid/content/res/Configuration;)Lcom/android/server/am/ActivityRecord;
    ...
    invoke-interface {v2, v3, v5, v6}, Lcom/lge/cappuccino/IMdm;->checkStartLockdownApps(Ljava/lang/String;Landroid/content/Intent;Z)V
...
.method final changeFocusToOverlay(Z)Z
    .locals 6
    .parameter "setVal"
    ...
    .line 5360
    invoke-direct {p0}, Lcom/android/server/am/ActivityStack;->isTopOverlayActivity()Z
    ...
    .end local v1           #r:Lcom/android/server/am/ActivityRecord;
    :cond_2
    invoke-virtual {p0}, Lcom/android/server/am/ActivityStack;->getOverlayNextTaskTopActivity()Lcom/android/server/am/ActivityRecord;
    ...
    .line 5374
    iput-boolean v2, p0, Lcom/android/server/am/ActivityStack;->mInChangingFocusToOverlay:Z
...
.method final ensureActivitiesVisibleLocked(Lcom/android/server/am/ActivityRecord;Lcom/android/server/am/ActivityRecord;Ljava/lang/String;I)V
    ...
    :cond_a
    iget-boolean v8, p0, Lcom/android/server/am/ActivityStack;->mInChangingFocusToOverlay:Z
    ...
    .line 1466
    .local v0, OverlayNextTaskTopActivity:Lcom/android/server/am/ActivityRecord;
    :goto_4
    if-ltz v6, :cond_b
    ...
    invoke-virtual {v8, v9}, Lcom/android/server/wm/WindowManagerService;->getExternalWindowStatus(Landroid/os/IBinder;)I
    :try_end_1
    ...
    .line 1486
    .local v5, externalWindowStatus:I
    ...
    .line 1494
    .end local v5           #externalWindowStatus:I
    :catch_1
    move-exception v4
    ...
    const-string v10, "[DSDR] Exception thrown - ensureActivitiesVisibleLocked() : "
...
.method public getMultiWindowFlag()Z
    .locals 3
    ...
    invoke-virtual {v2}, Lcom/android/server/wm/WindowManagerService;->getDsdrStatus()I
...
.method final getOverlayActivityName()Ljava/lang/String;
    .locals 5
    ...
    .line 5309
    .local v1, p:Lcom/android/server/am/ActivityRecord;
    iget-boolean v2, v1, Lcom/android/server/am/ActivityRecord;->isHomeActivity:Z
    ...
    .line 5314
    :cond_1
    iget-boolean v2, v1, Lcom/android/server/am/ActivityRecord;->isTopOverlay:Z
    ...
    const-string v4, "getOverlayActivityName, "
    ...
    const-string v3, "getOverlayActivityName, not found"
...
.method final getOverlayNextTaskTopActivity()Lcom/android/server/am/ActivityRecord;
    .locals 7
    ...
    .line 5086
    .local v2, overlayTaskID:I
    iget-boolean v5, p0, Lcom/android/server/am/ActivityStack;->mInChangingFocusToOverlay:Z
    ...
    .line 5091
    .local v3, p:Lcom/android/server/am/ActivityRecord;
    iget-boolean v5, v3, Lcom/android/server/am/ActivityRecord;->isTopOverlay:Z
    ...
    const-string v6, "getOverlayNextTaskTopActivity, overlayNextTaskID:"
    ...
    const-string v6, ", OverlayNextTaskTopActivity:"
...
.method final getOverlayTaskId()I
    .locals 6
    ...
    const-string v4, "getOverlayTaskId, taskId = "
...
.method final getPositionOverlayNextTaskTopActivity()I
    .locals 7
    ...
    .line 5109
    .local v3, p:Lcom/android/server/am/ActivityRecord;
    iget-boolean v4, v3, Lcom/android/server/am/ActivityRecord;->isTopOverlay:Z
    ...
    iget v2, v4, Lcom/android/server/am/TaskRecord;->taskId:I
    ...
    const-string v6, "getPositionOverlayNextTaskTopActivity, overlayNextTaskID:"
...
.method final isMediaOverlayActivity()Z
    .locals 2

    .prologue
    .line 5051
    invoke-virtual {p0}, Lcom/android/server/am/ActivityStack;->getOverlayActivityName()Ljava/lang/String;

    move-result-object v0

    .line 5052
    .local v0, topActivityName:Ljava/lang/String;
    ...
    const-string v1, "com.lge.videoplayer.MediaView"
    ...
    const-string v1, "com.lge.streamingplayer.StreamingPlayer"
    ...
    const-string v1, "com.lge.tdmb.TdmbMainScreenActivity"
    ...
    const-string v1, "com.lge.oneseg.TdmbMainScreenActivity"
    ...
    const-string v1, "com.uplus.onphone.page.player"
...
.method final isThereTopOverlay()Z
    .locals 6
...
.method final moveTaskForOverlay(I)V
    .locals 7
    .parameter "setVal"
    ...
    invoke-virtual {p0}, Lcom/android/server/am/ActivityStack;->releaseOverlay()V
    ...
    const-string v5, "[songhochan] sendEmptyMessage(MOVE_TO_BACK_MSG)"
...
.method final moveTaskToFrontLocked(Lcom/android/server/am/TaskRecord;Lcom/android/server/am/ActivityRecord;Landroid/os/Bundle;)V
    ...
    iget-object v10, p1, Lcom/android/server/am/TaskRecord;->realActivity:Landroid/content/ComponentName;
    ...
    iget-object v12, p0, Lcom/android/server/am/ActivityStack;->mContext:Landroid/content/Context;

    iget-object v13, p1, Lcom/android/server/am/TaskRecord;->realActivity:Landroid/content/ComponentName;

    invoke-virtual {v13}, Landroid/content/ComponentName;->getPackageName()Ljava/lang/String;

    move-result-object v13

    invoke-interface {v10, v11, v12, v13}, Lcom/lge/cappuccino/IMdm;->checkStartActivityLocked(Landroid/content/ComponentName;Landroid/content/Context;Ljava/lang/String;)I
    ...
    .line 4488
    .local v8, topAr:Lcom/android/server/am/ActivityRecord;
    if-ltz v7, :cond_1
    ...
    iget-object v11, v8, Lcom/android/server/am/ActivityRecord;->packageName:Ljava/lang/String;
    ...
    .line 4537
    .local v2, moved:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Landroid/os/IBinder;>;"
    iget-object v10, p0, Lcom/android/server/am/ActivityStack;->mHistory:Ljava/util/ArrayList;
    ...
    invoke-virtual {v10, v2}, Lcom/android/server/wm/WindowManagerService;->moveAppTokensToTop(Ljava/util/List;)V
    ...
    .line 4580
    invoke-direct {p0}, Lcom/android/server/am/ActivityStack;->findOverlayActivity()Lcom/android/server/am/ActivityRecord;

    move-result-object v9

    .line 4581
    .local v9, topOverlayRecord:Lcom/android/server/am/ActivityRecord;
    if-eqz v9, :cond_d
    ...
    invoke-virtual {p0, v10, v11, v0}, Lcom/android/server/am/ActivityStack;->moveTaskToFrontLocked(Lcom/android/server/am/TaskRecord;Lcom/android/server/am/ActivityRecord;Landroid/os/Bundle;)V

    .line 4591
    .end local v9           #topOverlayRecord:Lcom/android/server/am/ActivityRecord;
    :cond_d
    invoke-direct {p0, v6}, Lcom/android/server/am/ActivityStack;->finishTaskMoveLocked(I)V

    .line 4592
    const/16 v10, 0x7532

    invoke-static {v10, v6}, Landroid/util/EventLog;->writeEvent(II)I
...
.method final releaseOverlay()V
    ...
    .line 5405
    iput-boolean v5, v1, Lcom/android/server/am/ActivityRecord;->isTopOverlay:Z
    ...
    const-string v4, "releaseOverlay, isTopOverlay=false, "
    ...
    .end local v1           #p:Lcom/android/server/am/ActivityRecord;
    :cond_1
    iput-boolean v5, p0, Lcom/android/server/am/ActivityStack;->mInChangingFocusToOverlay:Z
...
.method final removeActivityFromHistoryLocked(Lcom/android/server/am/ActivityRecord;)V
    ...
    invoke-virtual {p0, p1, v2, v0}, Lcom/android/server/am/ActivityStack;->finishActivityResultsLocked(Lcom/android/server/am/ActivityRecord;ILandroid/content/Intent;)V

    .line 4206
    invoke-virtual {p1}, Lcom/android/server/am/ActivityRecord;->makeFinishing()V

    .line 4214
    iget-boolean v0, p1, Lcom/android/server/am/ActivityRecord;->isTopOverlay:Z

    if-eqz v0, :cond_0

    .line 4215
    iput-boolean v2, p1, Lcom/android/server/am/ActivityRecord;->isTopOverlay:Z
...
.method resolveActivity(Landroid/content/Intent;Ljava/lang/String;ILjava/lang/String;Landroid/os/ParcelFileDescriptor;I)Landroid/content/pm/ActivityInfo;
    ...
    .line 3262
    const-string v1, "DSDR_Intent"

    const-string v2, "set rInfo.DSDRIntent true"
    ...
    sput v1, Landroid/content/pm/ActivityInfo;->DSDRIntent:I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0

    .line 3274
    .end local v9           #isExternal:I
...
.method final resumeTopActivityLocked(Lcom/android/server/am/ActivityRecord;Landroid/os/Bundle;)Z
    ...
    invoke-direct {v0, v2}, Lcom/android/server/am/ActivityStack;->findSamePackageInOverlayTask(Ljava/lang/String;)Z
...
.method final setTopOverlayActivity(Z)Z
    .locals 9
    .parameter "setVal"
    ...
    iget-boolean v6, v2, Lcom/android/server/am/ActivityRecord;->isHomeActivity:Z
    ...
    .line 5248
    .local v3, secondTaskID:I
    iput-boolean p1, v2, Lcom/android/server/am/ActivityRecord;->isTopOverlay:Z

    .line 5249
    invoke-direct {p0}, Lcom/android/server/am/ActivityStack;->isSecondTaskSamePackage()I
    ...
    invoke-virtual {v6, v7, v3, v4}, Landroid/os/Handler;->obtainMessage(III)Landroid/os/Message;
    ...
    const-string v6, "[songhochan] sendEmptyMessage(MOVE_TO_BACK_MSG)"
    ...
    const-string v7, "setTopOverlayActivity, isTopOverlay=true,1 "

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    iget-object v7, v2, Lcom/android/server/am/ActivityRecord;->realActivity:Landroid/content/ComponentName;
    ...
    const-string v7, "com.lge.tdmb.TdmbMainScreenActivity"
...
.method final startActivityLocked(Landroid/app/IApplicationThread;Landroid/content/Intent;Ljava/lang/String;Landroid/content/pm/ActivityInfo;Landroid/os/IBinder;Ljava/lang/String;IIIILandroid/os/Bundle;Z[Lcom/android/server/am/ActivityRecord;)I
    ...
    .line 2591
    .local v20, alreadyRunningOverlay:Z
    const/16 v22, 0x0
    ...
    invoke-virtual {v3, v0}, Lcom/android/server/wm/WindowManagerService;->checkDsdrApp(Landroid/content/Intent;)V
    ...
    invoke-direct {v0, v3}, Lcom/android/server/am/ActivityStack;->findSamePackageInOverlayTask(Ljava/lang/String;)Z
    ...
    .line 2739
    .local v31, metaData:Landroid/os/Bundle;
    if-eqz v31, :cond_13
    ...
    .end local v31           #metaData:Landroid/os/Bundle;
    ...
    invoke-interface {v3, v4, v7, v8}, Lcom/lge/cappuccino/IMdm;->checkStartActivityLocked(Landroid/content/ComponentName;Landroid/content/Context;Ljava/lang/String;)I
    ...
    .line 2785
    .local v26, historyLists:Ljava/util/List;,"Ljava/util/List<Lcom/android/server/am/ActivityRecord;>;"
    ...
    .line 2786
    .local v27, hr:Lcom/android/server/am/ActivityRecord;
    move-object/from16 v0, v27
    ...
    .line 2797
    .end local v6           #r:Lcom/android/server/am/ActivityRecord;
    .end local v26           #historyLists:Ljava/util/List;,"Ljava/util/List<Lcom/android/server/am/ActivityRecord;>;"
    .end local v27           #hr:Lcom/android/server/am/ActivityRecord;
...
.method final topRunningActivityLocked(Landroid/os/IBinder;I)Lcom/android/server/am/ActivityRecord;
    ...
    .line 583
    :cond_0
    invoke-virtual {p0}, Lcom/android/server/am/ActivityStack;->getPositionOverlayNextTaskTopActivity()I
