...
.field public static final REPORT_DUAL_SCREEN_STATUS_CHANGE:I = 0x80
...
.field public static final WAITING_FOR_DUAL_SCREEN_WINDOW_DEACTIVATION_TIMEOUT:I = 0x7f
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 7205
    .local v33, wtoken:Lcom/android/server/wm/AppWindowToken;
    ...
    .end local v33           #wtoken:Lcom/android/server/wm/AppWindowToken;
    :sswitch_4
    move-object/from16 v0, p1
    ...
    .line 7262
    .restart local v33       #wtoken:Lcom/android/server/wm/AppWindowToken;
    const/16 v28, 0x0
    ...
    .line 7361
    .local v30, w:Lcom/android/server/wm/WindowState;
    ...
    .line 7367
    .end local v15           #i:I
    .end local v30           #w:Lcom/android/server/wm/WindowState;
    :catchall_6
    move-exception v2
    ...
    .line 7486
    .local v31, win:Landroid/os/IBinder;
    move-object/from16 v0, p0
    ...
    .line 7499
    .end local v31           #win:Landroid/os/IBinder;
    :sswitch_12
    move-object/from16 v0, p1
    ...
    .line 7503
    .restart local v31       #win:Landroid/os/IBinder;
    move-object/from16 v0, p0
    ...
    const-string v3, "[DSDR]handleMessage() : WAITING_FOR_DUAL_SCREEN_WINDOW_DEACTIVATION_TIMEOUT"
    ...
    const-string v3, "[DSDR]handleMessage() : destroying External Windows..."
    ...
    invoke-virtual {v2}, Lcom/android/server/wm/WindowManagerService;->destroyExternalWindows()V
    ...
    const-string v4, "[DSDR]handleMessage() : REPORT_DUAL_SCREEN_STATUS_CHANGE, mDualScreenStatus == "
    ...
    iget v4, v4, Lcom/android/server/wm/WindowManagerService;->mDualScreenStatus:I
    ...
    iget v2, v2, Lcom/android/server/wm/WindowManagerService;->mDualScreenStatus:I
    ...
    const-string v2, "android.intent.action.LG_DUAL_SCREEN_STATUS_CHANGED"
    ...
    .line 7573
    .local v20, notifyIntent:Landroid/content/Intent;
    ...
    iget-boolean v3, v3, Lcom/android/server/wm/WindowManagerService;->mDualScreenActivated:Z
    ...
    iget v3, v3, Lcom/android/server/wm/WindowManagerService;->mDualScreenStatus:I
    ...
    const-string v4, "[DSDR]handleMessage() : sending broadcast - mDualScreenActivated == "
    ...
    iget-boolean v4, v4, Lcom/android/server/wm/WindowManagerService;->mDualScreenActivated:Z
    ...
    .line 7537
    .end local v20           #notifyIntent:Landroid/content/Intent;
    :pswitch_1
    move-object/from16 v0, p0
    ...
    iput-boolean v3, v2, Lcom/android/server/wm/WindowManagerService;->mDualScreenConnected:Z
    ...
    iget-boolean v2, v2, Lcom/android/server/wm/WindowManagerService;->mDualScreenActivated:Z
    ...
    iput-boolean v3, v2, Lcom/android/server/wm/WindowManagerService;->mDualScreenVisible:Z
    ...
    const-string v3, "notifyDsdrStatus:context is null"
