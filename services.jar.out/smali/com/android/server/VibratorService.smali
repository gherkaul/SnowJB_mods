...
.method static synthetic access$1500(Lcom/android/server/VibratorService;J)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$1700(Lcom/android/server/VibratorService;)Z
    .locals 1
    .parameter "x0"

    .prologue
    .line 53
    invoke-direct {p0}, Lcom/android/server/VibratorService;->isCall()Z
...
.method private doVibratorOn(JI)V
    ...
    invoke-static {v2, p3}, Lcom/android/server/VibratorService;->vibratorOnEx(II)V
...
.method private isCall()Z
    ...
    const-string v4, "ITelephony threw Exception"
...
.method private vibrate(JILandroid/os/IBinder;)V
    .locals 7
...
.method static native vibratorOnEx(II)V
.end method
...
.method public getVibrateVolume()I
    ...
    sget-object v1, Landroid/provider/Settings$System;->VOLUME_VIBRATE_ALL:[Ljava/lang/String;
...
.method public vibrateIndex(JILandroid/os/IBinder;)V
    .locals 0
    .parameter "milliseconds"
    .parameter "volumeIndex"
    .parameter "token"
    ...
    .prologue
    .line 751
    invoke-direct {p0, p1, p2, p3, p4}, Lcom/android/server/VibratorService;->vibrate(JILandroid/os/IBinder;)V
...
.method public vibratePattern([JI[ILandroid/os/IBinder;)V
    ...
    invoke-direct/range {v0 .. v6}, Lcom/android/server/VibratorService$Vibration;-><init>(Lcom/android/server/VibratorService;Landroid/os/IBinder;[JI[II)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1
...
.method public vibratePatternIndex([JI[ILandroid/os/IBinder;)V
    .locals 0
    .parameter "pattern"
    .parameter "repeat"
    .parameter "volumeIndex"
    ...
    .prologue
    .line 757
    invoke-virtual {p0, p1, p2, p3, p4}, Lcom/android/server/VibratorService;->vibratePattern([JI[ILandroid/os/IBinder;)V
