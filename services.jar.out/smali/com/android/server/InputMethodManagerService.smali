...
.field static final IME_VISIBILITY_NOTIFICATION_DELAY:J = 0x3e8L

.field private static final INTENT_BOOT_ANI_END:Ljava/lang/String; = "com.android.systemui.BOOT_ANI_END"
...
.field static final MSG_IME_VISIBILITY_CHANGED:I = 0x384
...
.field private static mCCSAsInterfaceMethod:Ljava/lang/reflect/Method;

.field private static mCCSSetLowPowerModePolicyMethod:Ljava/lang/reflect/Method;
...
.field private mFeatIMEPowerSave:Z
...
.field private mICoreControlService:Ljava/lang/Object;
...
.method static constructor <clinit>()V
    ...
    sput-object v8, Lcom/android/server/InputMethodManagerService;->NOT_A_SUBTYPE_ID_STR:Ljava/lang/String;
    ...
    sput-object v8, Lcom/android/server/InputMethodManagerService;->ENGLISH_LOCALE:Ljava/util/Locale;

    .line 2352
    sput-object v10, Lcom/android/server/InputMethodManagerService;->mCCSSetLowPowerModePolicyMethod:Ljava/lang/reflect/Method;

    .line 2353
    sput-object v10, Lcom/android/server/InputMethodManagerService;->mCCSAsInterfaceMethod:Ljava/lang/reflect/Method;

    .line 2357
    :try_start_0
    const-string v8, "com.lge.systemservice.core.corecontrolmanager.ICoreControlManager"
    ...
    .line 2358
    .local v2, ccsInterface:Ljava/lang/Class;
    const/4 v7, 0x0

    .line 2359
    .local v7, stubClass:Ljava/lang/Class;
    ...
    .line 2367
    const-string v8, "android.os.IBinder"
    ...
    sput-object v8, Lcom/android/server/InputMethodManagerService;->mCCSAsInterfaceMethod:Ljava/lang/reflect/Method;

    .line 2372
    .end local v1           #binderClass:Ljava/lang/Class;
    :cond_1
    sget-object v8, Lcom/android/server/InputMethodManagerService;->mCCSSetLowPowerModePolicyMethod:Ljava/lang/reflect/Method;

    if-nez v8, :cond_2

    .line 2373
    const-string v8, "setLowPowerModePolicy"
    ...
    sput-object v8, Lcom/android/server/InputMethodManagerService;->mCCSSetLowPowerModePolicyMethod:Ljava/lang/reflect/Method;
    :try_end_0
    ...
    const-string v10, "ccs service not found:  "
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/wm/WindowManagerService;)V
    ...
    iput-object v6, p0, Lcom/android/server/InputMethodManagerService;->country:Ljava/lang/String;
    ...
    .line 412
    iput-boolean v4, p0, Lcom/android/server/InputMethodManagerService;->mFeatIMEPowerSave:Z

    .line 2351
    iput-object v9, p0, Lcom/android/server/InputMethodManagerService;->mICoreControlService:Ljava/lang/Object;
    ...
    invoke-static {v6, v4, v2, v4}, Landroid/app/PendingIntent;->getBroadcast(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
    ...
    invoke-virtual {v6, v7, v9, v5}, Lcom/android/server/InputMethodManagerService$MyPackageMonitor;->register(Landroid/content/Context;Landroid/os/Looper;Z)V
    ...
    .line 667
    const-string v6, "com.android.systemui.BOOT_ANI_END"
    ...
    invoke-virtual {p0, v4, v6}, Lcom/android/server/InputMethodManagerService;->buildInputMethodListLocked(Ljava/util/ArrayList;Ljava/util/HashMap;)V
    ...
    invoke-direct {v4, p0, v6}, Lcom/android/server/InputMethodManagerService$SettingsObserver;-><init>(Lcom/android/server/InputMethodManagerService;Landroid/os/Handler;)V
    ...
    .line 694
    .local v1, featIMEPowerSave:Ljava/lang/String;
    if-eqz v1, :cond_2
    ...
    .line 695
    iput-boolean v5, p0, Lcom/android/server/InputMethodManagerService;->mFeatIMEPowerSave:Z
    ...
    .end local v1           #featIMEPowerSave:Ljava/lang/String;
...
.method private bindPowerSaveService()V
    .locals 6

    .prologue
    .line 2382
    sget-object v2, Lcom/android/server/InputMethodManagerService;->mCCSAsInterfaceMethod:Ljava/lang/reflect/Method;
    ...
    const-string v3, "Failed to bind: ccs service not found"
    ...
    .line 2387
    :cond_1
    iget-object v2, p0, Lcom/android/server/InputMethodManagerService;->mICoreControlService:Ljava/lang/Object;
    ...
    iput-object v2, p0, Lcom/android/server/InputMethodManagerService;->mICoreControlService:Ljava/lang/Object;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string v4, "Failed on ccs service connection:  "
...
.method private notifyIMEStateChange()V
    .locals 4
    ...
    .line 2413
    iget-boolean v0, p0, Lcom/android/server/InputMethodManagerService;->mFeatIMEPowerSave:Z
...
.method private setLowPowerModePolicy(Z)V
    .locals 6
    .parameter "on"

    .prologue
    .line 2398
    invoke-direct {p0}, Lcom/android/server/InputMethodManagerService;->bindPowerSaveService()V

    .line 2399
    iget-object v1, p0, Lcom/android/server/InputMethodManagerService;->mICoreControlService:Ljava/lang/Object;

    if-eqz v1, :cond_0

    sget-object v1, Lcom/android/server/InputMethodManagerService;->mCCSSetLowPowerModePolicyMethod:Ljava/lang/reflect/Method;
    ...
    const-string v2, "Failed: ccs service not found"
    ...
    const-string v3, "Failed on ccs service call:  "
...
.method private showInputMethodMenuInternal(Z)V
    ...
    invoke-virtual/range {v28 .. v28}, Landroid/app/KeyguardManager;->isKeyguardSecure()Z
    ...
    .end local v23           #lastInputMethodId:Ljava/lang/String;
    .end local v24           #lastInputMethodSubtypeId:I
    :cond_1
    const/16 v18, 0x0
    ...
    .restart local v23       #lastInputMethodId:Ljava/lang/String;
    .restart local v24       #lastInputMethodSubtypeId:I
    :cond_2
    ...
    .line 2562
    .local v11, handwritingItem:I
    const/16 v22, -0x1

    .line 2563
    .local v22, iwnnimeItem:I
    const/16 v20, -0x1

    .line 2565
    .local v20, iwnnSymbolItem:I
    const/4 v14, 0x0
    ...
    iget-object v0, v0, Lcom/android/server/InputMethodManagerService;->country:Ljava/lang/String;
    ...
    const-string v30, "com.sevenknowledge.sevennotestabproduct.lg001.tab50"
    ...
    const-string v30, "jp.co.omronsoft.iwnnime.ml"
    ...
    invoke-virtual/range {v28 .. v28}, Landroid/view/inputmethod/InputMethodSubtype;->getExtraValue()Ljava/lang/String;

    move-result-object v28

    const-string v30, "symbolinput"
    ...
    invoke-virtual/range {v28 .. v28}, Lcom/android/server/wm/WindowManagerService;->isHardKeyboardEnabled()Z
    ...
    invoke-direct {v6, v8, v0, v15, v7}, Lcom/android/server/InputMethodManagerService$ImeSubtypeListAdapter;-><init>(Landroid/content/Context;ILjava/util/List;I)V
    ...
    .line 2654
    .local v12, handwritingItemFinal:I
    move/from16 v21, v20

    .line 2657
    .local v21, iwnnSymbolItemFinal:I
    move-object/from16 v0, p0
    ...
    invoke-direct {v0, v1, v2, v12}, Lcom/android/server/InputMethodManagerService$5;-><init>(Lcom/android/server/InputMethodManagerService;II)V
    ...
    .end local v11           #handwritingItem:I
    .end local v12           #handwritingItemFinal:I
    .end local v13           #hardKeySwitch:Landroid/widget/Switch;
    .end local v14           #i:I
    .end local v15           #imList:Ljava/util/List;,"Ljava/util/List<Lcom/android/server/InputMethodManagerService$ImeSubtypeListItem;>;"
    .end local v16           #immis:Ljava/util/HashMap;,"Ljava/util/HashMap<Landroid/view/inputmethod/InputMethodInfo;Ljava/util/List<Landroid/view/inputmethod/InputMethodSubtype;>;>;"
    .end local v17           #inflater:Landroid/view/LayoutInflater;
    .end local v20           #iwnnSymbolItem:I
    .end local v21           #iwnnSymbolItemFinal:I
    .end local v22           #iwnnimeItem:I
    ...
    .restart local v11       #handwritingItem:I
    .restart local v14       #i:I
    .restart local v15       #imList:Ljava/util/List;,"Ljava/util/List<Lcom/android/server/InputMethodManagerService$ImeSubtypeListItem;>;"
    .restart local v16       #immis:Ljava/util/HashMap;,"Ljava/util/HashMap<Landroid/view/inputmethod/InputMethodInfo;Ljava/util/List<Landroid/view/inputmethod/InputMethodSubtype;>;>;"
    .restart local v20       #iwnnSymbolItem:I
    .restart local v22       #iwnnimeItem:I
    :cond_10
    const/16 v28, 0x0
...
.method public getEnabledInputMethodSubtypeListLocked(Landroid/view/inputmethod/InputMethodInfo;Z)Ljava/util/List;
    ...
    invoke-virtual {v3, p1}, Lcom/android/server/InputMethodManagerService$InputMethodSettings;->getEnabledInputMethodSubtypeListLocked(Landroid/view/inputmethod/InputMethodInfo;)Ljava/util/List;
    ...
    invoke-static {v3, p1}, Lcom/android/server/InputMethodManagerService;->getImplicitlyApplicableSubtypesLocked(Landroid/content/res/Resources;Landroid/view/inputmethod/InputMethodInfo;)Ljava/util/ArrayList;

    move-result-object v0

    .line 909
    :cond_1
    iget-object v3, p0, Lcom/android/server/InputMethodManagerService;->country:Ljava/lang/String;
    ...
    .local v1, it:Ljava/util/Iterator;,"Ljava/util/Iterator<Landroid/view/inputmethod/InputMethodSubtype;>;"
    :cond_2
    :goto_0
    invoke-interface {v1}, Ljava/util/Iterator;->hasNext()Z
    ...
    const-string v4, "com.sevenknowledge.sevennotestabproduct.lg001.tab50"
    ...
    .line 919
    .end local v1           #it:Ljava/util/Iterator;,"Ljava/util/Iterator<Landroid/view/inputmethod/InputMethodSubtype;>;"
    ...
    invoke-static {v3, v4, p1, v0}, Landroid/view/inputmethod/InputMethodSubtype;->sort(Landroid/content/Context;ILandroid/view/inputmethod/InputMethodInfo;Ljava/util/List;)Ljava/util/List;
...
.method public handleMessage(Landroid/os/Message;)Z
    ...
    :goto_1
    invoke-direct {p0, v3}, Lcom/android/server/InputMethodManagerService;->setLowPowerModePolicy(Z)V
...
.method hideCurrentInputLocked(ILandroid/os/ResultReceiver;)Z
    ...
    .line 1737
    invoke-direct {p0}, Lcom/android/server/InputMethodManagerService;->notifyIMEStateChange()V
...
.method public setImeWindowStatus(Landroid/os/IBinder;II)V
    ...
    invoke-virtual {v13, v15, v11, v10, v0}, Landroid/app/Notification;->setLatestEventInfo(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Landroid/app/PendingIntent;)V

    .line 1428
    move-object/from16 v0, p0

    iget-object v13, v0, Lcom/android/server/InputMethodManagerService;->country:Ljava/lang/String;
    ...
    const-string v15, "jp.co.omronsoft.iwnnime.ml/.standardcommon.IWnnLanguageSwitcher"
    ...
    .line 1431
    .local v7, imiIwnn:Landroid/view/inputmethod/InputMethodInfo;
    if-eqz v7, :cond_3
    ...
    const-string v15, "com.sevenknowledge.sevennotestabproduct.lg001.tab50"
    ...
    invoke-virtual {v13, v15, v11, v0, v1}, Landroid/app/Notification;->setLatestEventInfo(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Landroid/app/PendingIntent;)V

    .line 1439
    .end local v7           #imiIwnn:Landroid/view/inputmethod/InputMethodInfo;
    :cond_3
    move-object/from16 v0, p0
