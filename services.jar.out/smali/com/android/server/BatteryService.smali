...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/server/BatteryService$acc_cable_type;
    }
.end annotation
...
.field private mWcFTTLevel:I

.field private mWcOnline:Z
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/LightsService;)V
    ...
    .line 148
    iput v4, p0, Lcom/android/server/BatteryService;->ext_pwr:I
...
.method static synthetic access$200(Lcom/android/server/BatteryService;)Lcom/android/server/BatteryService$batteryCheckHandler;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$202(Lcom/android/server/BatteryService;Lcom/android/server/BatteryService$batteryCheckHandler;)Lcom/android/server/BatteryService$batteryCheckHandler;
    .locals 0
    .parameter "x0"
    .parameter "x1"
    ...
    .prologue
    .line 89
    iput-object p1, p0, Lcom/android/server/BatteryService;->mHandler:Lcom/android/server/BatteryService$batteryCheckHandler;
...
.method private processValues()V
    ...
    .line 398
    :cond_10
    sget-boolean v0, Lcom/lge/config/ConfigBuildFlags;->CAPP_WIRELESS_CHARGING:Z

    if-eqz v0, :cond_11

    iget-boolean v0, p0, Lcom/android/server/BatteryService;->mWcOnline:Z
...
.method private final sendIntent()V
    ...
    .line 562
    :cond_1
    sget-boolean v2, Lcom/lge/config/ConfigBuildFlags;->CAPP_WIRELESS_CHARGING:Z

    if-eqz v2, :cond_2

    .line 564
    const-string v2, "wireless_ftt_level"

    iget v3, p0, Lcom/android/server/BatteryService;->mWcFTTLevel:I
...
.method private final shutdownIfNoPower()V
    ...
    invoke-virtual {p0}, Lcom/android/server/BatteryService;->isPIF200()Z
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    const-string v1, "  WC powered: "

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    iget-boolean v1, p0, Lcom/android/server/BatteryService;->mWcOnline:Z
    ...
    const-string v1, "  WC FTT Level: "

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    iget v1, p0, Lcom/android/server/BatteryService;->mWcFTTLevel:I
    ...
    iget v1, p0, Lcom/android/server/BatteryService;->ext_pwr:I
...
.method final isPIF200()Z
    ...
    .line 245
    iput v5, p0, Lcom/android/server/BatteryService;->ext_pwr:I

    .line 247
    const-string v1, "/sys/class/power_supply/battery/ext_pwr"
    ...
    iput v6, p0, Lcom/android/server/BatteryService;->ext_pwr:I
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1
    ...
    const-string v8, "ext_pwr = "

    invoke-virtual {v7, v8}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v7

    iget v8, p0, Lcom/android/server/BatteryService;->ext_pwr:I
    ...
    .line 272
    iget v6, p0, Lcom/android/server/BatteryService;->ext_pwr:I
    ...
    .line 265
    .restart local v2       #pathFile:Ljava/io/File;
    :catch_0
    move-exception v0
...
.method final isPowered()Z
    ...
    iget-boolean v2, p0, Lcom/android/server/BatteryService;->mWcOnline:Z
...
.method final isPowered(I)Z
    ...
    .line 234
    :cond_4
    sget-boolean v3, Lcom/lge/config/ConfigBuildFlags;->CAPP_WIRELESS_CHARGING:Z

    if-eqz v3, :cond_5

    iget-boolean v3, p0, Lcom/android/server/BatteryService;->mWcOnline:Z
