...
.method private TraverseViewRootImpl(Z)Z
    .locals 9
    .parameter "isOn"
    ...
    invoke-interface {v4}, Landroid/view/WindowManager;->getNumOfViewRootImpl()I

    move-result v0

    .line 2029
    .local v0, N:I
    const-string v5, "Real3D"

    new-instance v7, Ljava/lang/StringBuilder;

    invoke-direct {v7}, Ljava/lang/StringBuilder;-><init>()V

    const-string v8, "Get WindowManager "
    ...
    const-string v8, " and the num of ViewRootImpl = "
    ...
    .line 2032
    invoke-interface {v4, v2}, Landroid/view/WindowManager;->getViewRootImpl(I)Landroid/view/ViewRootImpl;
    ...
    const-string v8, "Content View found ? = "
    ...
    const-string v8, "th ViewRootImpl"
    ...
    :try_start_0
    invoke-direct {p0, v3, v5, p1}, Lcom/android/internal/policy/impl/PhoneWindow$DecorView;->traversalSurfaceView(Landroid/view/ViewGroup;IZ)Z
    :try_end_0
    ...
    const-string v7, "traversal falied. pass this viewRoot"
...
.method private traversalSurfaceView(Landroid/view/ViewGroup;IZ)Z
    .locals 15
    .parameter "view"
    ...
    .line 1995
    .local v9, sv:Landroid/view/SurfaceView;
    invoke-virtual {v9}, Landroid/view/SurfaceView;->getHolder()Landroid/view/SurfaceHolder;

    move-result-object v5

    check-cast v5, Landroid/view/S3DSurfaceHolder;

    .line 1996
    .local v5, holder:Landroid/view/S3DSurfaceHolder;
    const/4 v7, 0x0

    .line 1998
    .local v7, info:Landroid/view/S3DInfo;
    :try_start_0
    invoke-interface {v5}, Landroid/view/S3DSurfaceHolder;->getS3DInfo()Landroid/view/S3DInfo;
    :try_end_0
    ...
    iget v11, v7, Landroid/view/S3DInfo;->type:I
    ...
    new-instance v11, Landroid/view/S3DInfo;
    ...
    invoke-direct {v11, v12, v13, v14}, Landroid/view/S3DInfo;-><init>(ZII)V

    invoke-interface {v5, v11}, Landroid/view/S3DSurfaceHolder;->setS3DInfo(Landroid/view/S3DInfo;)V

    .line 2007
    const-string v11, "Real3D"

    const-string v12, "SurfaceView set as S3D_AC.."
    ...
    :cond_2
    :goto_2
    instance-of v11, v10, Landroid/opengl/GLSurfaceView;
    ...
    .line 2014
    .local v4, gv:Landroid/opengl/GLSurfaceView;
    invoke-virtual {v4}, Landroid/opengl/GLSurfaceView;->requestRender()V

    .line 2016
    .end local v4           #gv:Landroid/opengl/GLSurfaceView;
    :cond_3
    const/4 v11, 0x1
    ...
    const-string v12, "getS3DInfo falied. pass this surfaceview"

    invoke-static {v11, v12}, Landroid/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)I

    .line 1991
    .end local v3           #e:Ljava/lang/NullPointerException;
    .end local v5           #holder:Landroid/view/S3DSurfaceHolder;
    .end local v7           #info:Landroid/view/S3DInfo;
    .end local v9           #sv:Landroid/view/SurfaceView;
    :cond_4
    ...
    .line 2008
    .restart local v5       #holder:Landroid/view/S3DSurfaceHolder;
    .restart local v7       #info:Landroid/view/S3DInfo;
    .restart local v9       #sv:Landroid/view/SurfaceView;
    :cond_5
    if-nez p3, :cond_2
    ...
    invoke-direct {v11}, Landroid/view/S3DInfo;-><init>()V
    ...
    const-string v12, "SurfaceView set as normal 2D.."
    ...
    const-string v13, "there is no surfaceview.. pass through...count = "
    ...
    invoke-direct {p0, v10, v0, v1}, Lcom/android/internal/policy/impl/PhoneWindow$DecorView;->traversalSurfaceView(Landroid/view/ViewGroup;IZ)Z
...
.method public dispatchKeyEvent(Landroid/view/KeyEvent;)Z
    ...
    :goto_2
    invoke-direct {p0, v11}, Lcom/android/internal/policy/impl/PhoneWindow$DecorView;->TraverseViewRootImpl(Z)Z
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {v11}, Lcom/android/internal/policy/impl/PhoneWindow;->access$600(Lcom/android/internal/policy/impl/PhoneWindow;)I
    ...
    invoke-static {v11}, Lcom/android/internal/policy/impl/PhoneWindow;->access$700(Lcom/android/internal/policy/impl/PhoneWindow;)Lcom/android/internal/policy/impl/PhoneWindow$PanelFeatureState;
    ...
    #getter for: Lcom/android/internal/policy/impl/PhoneWindow;->mPreparedPanel:Lcom/android/internal/policy/impl/PhoneWindow$PanelFeatureState;
    invoke-static {v12}, Lcom/android/internal/policy/impl/PhoneWindow;->access$700(Lcom/android/internal/policy/impl/PhoneWindow;)Lcom/android/internal/policy/impl/PhoneWindow$PanelFeatureState;
    ...
    invoke-static {v11, v12, v8, p1, v10}, Lcom/android/internal/policy/impl/PhoneWindow;->access$800(Lcom/android/internal/policy/impl/PhoneWindow;Lcom/android/internal/policy/impl/PhoneWindow$PanelFeatureState;ILandroid/view/KeyEvent;I)Z
...
.method protected onDetachedFromWindow()V
    ...
    .line 2765
    :cond_2
    iput-object v4, p0, Lcom/android/internal/policy/impl/PhoneWindow$DecorView;->mActionModePopup:Landroid/widget/PopupWindow;
    ...
    invoke-static {v2}, Lcom/android/internal/policy/impl/PhoneWindow;->access$1800(Lcom/android/internal/policy/impl/PhoneWindow;)Landroid/app/Dialog;
    ...
    invoke-static {v2, v4}, Lcom/android/internal/policy/impl/PhoneWindow;->access$1802(Lcom/android/internal/policy/impl/PhoneWindow;Landroid/app/Dialog;)Landroid/app/Dialog;
...
.method public onWindowFocusChanged(Z)V
    ...
    invoke-static {v1, v2}, Lcom/android/internal/policy/impl/PhoneWindow;->access$1602(Lcom/android/internal/policy/impl/PhoneWindow;Z)Z
