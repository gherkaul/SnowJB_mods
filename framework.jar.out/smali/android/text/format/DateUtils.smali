...
.field private static mShowLocalizedDigits:Z
...
.method public static formatDateRange(Landroid/content/Context;Ljava/util/Formatter;JJILjava/lang/String;)Ljava/util/Formatter;
    ...
    .line 1573
    sget-boolean v62, Landroid/text/format/DateUtils;->mShowLocalizedDigits:Z

    if-eqz v62, :cond_55

    .line 1574
    invoke-static {v11}, Landroid/text/format/DateUtils;->localizeDigits(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 1604
    invoke-static/range {v58 .. v58}, Landroid/text/format/DateUtils;->localizeDigits(Ljava/lang/String;)Ljava/lang/String;
...
.method public static formatElapsedTime(Ljava/lang/StringBuilder;J)Ljava/lang/String;
    ...
    sput-boolean v0, Landroid/text/format/DateUtils;->mShowLocalizedDigits:Z
...
.method private static formatElapsedTime(Ljava/lang/StringBuilder;Ljava/lang/String;JJ)Ljava/lang/String;
    ...
    .line 779
    .local v0, locale_time_padding:C
    sget-boolean v2, Landroid/text/format/DateUtils;->mShowLocalizedDigits:Z
    ...
    invoke-static {v2, v3}, Landroid/text/format/DateUtils;->toDigitChar(J)C
    ...
    .line 810
    .end local v0           #locale_time_padding:C
    .end local v1           #sb:Ljava/lang/StringBuilder;
    :goto_3
    return-object v2

    .line 786
    .restart local v0       #locale_time_padding:C
    .restart local v1       #sb:Ljava/lang/StringBuilder;
    :cond_1
...
.method private static localizeDigits(Ljava/lang/String;)Ljava/lang/String;
    .locals 9
    .parameter "str"
...
.method private static toDigitChar(J)C
    ...
    .line 816
    sget-boolean v0, Landroid/text/format/DateUtils;->mShowLocalizedDigits:Z
