...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/text/StaticLayout;->TARGET_OPERATOR:Ljava/lang/String;
...
.method generate(Ljava/lang/CharSequence;IILandroid/text/TextPaint;ILandroid/text/TextDirectionHeuristic;FFZZFLandroid/text/TextUtils$TruncateAt;)V
    ...
    .line 298
    .local v108, isCurrentCharEmoji:Z
    const/16 v5, 0xa
    ...
    .line 271
    .end local v95           #c:C
    .end local v108           #isCurrentCharEmoji:Z
    :cond_18
    :goto_a
    ...
    .restart local v108       #isCurrentCharEmoji:Z
    ...
    .line 354
    .local v131, whichPaint:Landroid/text/TextPaint;
    :cond_1e
    :goto_b
    ...
    .line 336
    .end local v131           #whichPaint:Landroid/text/TextPaint;
    .end local v132           #wid:F
    :cond_1f
    sget-object v5, Landroid/text/StaticLayout;->TARGET_OPERATOR:Ljava/lang/String;
    ...
    .restart local v131       #whichPaint:Landroid/text/TextPaint;
    goto :goto_b
    ...
    aget-object v124, v93, v107

    .line 346
    .local v124, span:Landroid/text/style/MetricAffectingSpan;
    ...
    .end local v107           #i$:I
    .end local v110           #len$:I
    .end local v124           #span:Landroid/text/style/MetricAffectingSpan;
    .end local v129           #spans:[Landroid/text/style/MetricAffectingSpan;
    .end local v131           #whichPaint:Landroid/text/TextPaint;
    :cond_21
    move-object/from16 v0, p0
