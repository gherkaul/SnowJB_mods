...
.field private static final BLOCK_AVRCP_TOGGLE_BLACKLIST:Ljava/lang/String; = "/etc/bluetooth/block_avrcp_toggle.conf"
...
.field private mBlockAvrcpToggleAddresssBlacklist:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList",
            "<",
...
.method constructor <init>(Landroid/content/Context;Landroid/server/BluetoothService;)V
    ...
    .line 104
    invoke-virtual {p0}, Landroid/server/BluetoothBondState;->readBlockAVRCPToggleData()V
...
.method public isBlockAVRCPToggleBlacklist(Ljava/lang/String;)Z
    .locals 3
    .parameter "address"

    .prologue
    .line 257
    iget-object v2, p0, Landroid/server/BluetoothBondState;->mBlockAvrcpToggleAddresssBlacklist:Ljava/util/ArrayList;
...
.method public declared-synchronized readBlockAVRCPToggleData()V
    .locals 11
    ...
    :try_start_0
    iget-object v8, p0, Landroid/server/BluetoothBondState;->mBlockAvrcpToggleAddresssBlacklist:Ljava/util/ArrayList;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_1
    ...
    const-string v8, "/etc/bluetooth/block_avrcp_toggle.conf"
    ...
    iput-object v8, p0, Landroid/server/BluetoothBondState;->mBlockAvrcpToggleAddresssBlacklist:Ljava/util/ArrayList;
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_2
    ...
    const-string v10, "FileNotFoundException: readBlockAVRCPToggleData "
    ...
    const-string v9, "Error parsing Block AVRCP Toggle blacklist file"
    ...
    const-string v10, "IOException: readBlockAVRCPToggleData "
...
.method public declared-synchronized setBondState(Ljava/lang/String;IIZ)V
    ...
    const-string/jumbo v5, "setBondState =>  state: "
    ...
    const-string/jumbo v5, "odl state:"
    ...
    const-string/jumbo v4, "setBondState MDM block when Bond success"
