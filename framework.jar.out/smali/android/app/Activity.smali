...
.field private oldLp:Landroid/view/WindowManager$LayoutParams;
...
.method static constructor <clinit>()V
    ...
    const-string v1, "jp.co.mmbi.app"
...
.method public constructor <init>()V
    ...
    .line 718
    iput-object v2, p0, Landroid/app/Activity;->mDsdrDlg:Landroid/app/Dialog;
    ...
    iput-object v0, p0, Landroid/app/Activity;->oldLp:Landroid/view/WindowManager$LayoutParams;
...
.method private checkReal3DProfile(Landroid/content/Intent;)V
    ...
    invoke-direct {p0, v9, v0, v1}, Landroid/app/Activity;->traversalSurfaceView(Landroid/view/ViewGroup;IZ)Z
...
.method private getOverlayMode()Z
    .locals 11
    ...
    const-string v10, "Activity.java [getOverlayMode] Overlay Start, MyPackageName:"
    ...
    const-string v10, ", OverlayActivityName:"
    ...
    .end local v3           #layoutTitle:Ljava/lang/String;
    .end local v4           #lpWindow:Landroid/view/WindowManager$LayoutParams;
    .end local v5           #myActivityName:Ljava/lang/String;
...
.method private isExternal()Z
    ...
    invoke-virtual {v3}, Landroid/view/Display;->getDsdrStatus()I
...
.method private sendBroadcastShowStatusBarOverlay()V
    .locals 8
    ...
    .line 5572
    .local v5, overlayActivityName:Ljava/lang/String;
    ...
    .line 5574
    .local v4, myActivityName:Ljava/lang/String;
    ...
    const-string v6, "com.lge.Overlay.action.SHOW_STATUS_BAR"
    ...
    .end local v2           #layoutTitle:Ljava/lang/String;
    .end local v4           #myActivityName:Ljava/lang/String;
    .end local v5           #overlayActivityName:Ljava/lang/String;
    :cond_0
    return-void

    .line 5579
    .restart local v1       #intent:Landroid/content/Intent;
    .restart local v2       #layoutTitle:Ljava/lang/String;
    .restart local v4       #myActivityName:Ljava/lang/String;
    .restart local v5       #overlayActivityName:Ljava/lang/String;
    :cond_1
    const-string/jumbo v6, "showStatusBar"
...
.method private sendBroadcastShowStatusBarOverlay(Landroid/view/WindowManager$LayoutParams;)V
    .locals 8
    .parameter "lpWindow"
    ...
    iget-object v6, p0, Landroid/app/Activity;->oldLp:Landroid/view/WindowManager$LayoutParams;
    ...
    .restart local v3       #layoutTitle:Ljava/lang/String;
    .restart local v4       #myActivityName:Ljava/lang/String;
    .restart local v5       #overlayActivityName:Ljava/lang/String;
    :cond_4
    const-string/jumbo v6, "showStatusBar"
...
.method private traversalSurfaceView(Landroid/view/ViewGroup;IZ)Z
    ...
    invoke-direct {v8, v9, v10, v11}, Landroid/view/S3DInfo;-><init>(ZII)V
    ...
    invoke-direct {p0, v7, p2, p3}, Landroid/app/Activity;->traversalSurfaceView(Landroid/view/ViewGroup;IZ)Z
...
.method private unhideFloatingAppsIfNeeded(Z)V
    .locals 10
    .parameter "forceIfBaseActivity"
...
.method protected onDestroy()V
    ...
    :cond_0
    :goto_0
    invoke-direct {p0, v11}, Landroid/app/Activity;->unhideFloatingAppsIfNeeded(Z)V
...
.method protected onPause()V
    ...
    :cond_0
    :goto_0
    invoke-direct {p0, v5}, Landroid/app/Activity;->unhideFloatingAppsIfNeeded(Z)V
...
.method protected onResume()V
    ...
    .line 1247
    invoke-direct {p0}, Landroid/app/Activity;->sendBroadcastShowStatusBarOverlay()V

    .line 1253
    sget v1, Landroid/content/pm/ActivityInfo;->DSDRIntent:I
    ...
    iput v2, v0, Landroid/view/WindowManager$LayoutParams;->extUsage:I

    .line 1257
    .end local v0           #lp:Landroid/view/WindowManager$LayoutParams;
    :cond_1
    iget-object v1, p0, Landroid/app/Activity;->mDsdrDlg:Landroid/app/Dialog;
    ...
    const-string v2, "[DSDR] onResume() - mDsdrDlg.dismiss()"
    ...
    iput-object v1, p0, Landroid/app/Activity;->mDsdrDlg:Landroid/app/Dialog;
...
.method protected onStop()V
    ...
    .line 1567
    invoke-direct {p0, v1}, Landroid/app/Activity;->unhideFloatingAppsIfNeeded(Z)V
...
.method public onWindowAttributesChanged(Landroid/view/WindowManager$LayoutParams;)V
    ...
    .line 2498
    invoke-direct {p0, p1}, Landroid/app/Activity;->sendBroadcastShowStatusBarOverlay(Landroid/view/WindowManager$LayoutParams;)V
...
.method final performDestroy()V
    ...
    .line 5467
    :cond_0
    iget-object v0, p0, Landroid/app/Activity;->mDsdrDlg:Landroid/app/Dialog;
    ...
    const-string v1, "[DSDR] performDestroy() - mDsdrDlg.dismiss()"
    ...
    iput-object v0, p0, Landroid/app/Activity;->mDsdrDlg:Landroid/app/Dialog;
...
.method final performPause()V
    ...
    .line 5339
    invoke-direct {p0}, Landroid/app/Activity;->getOverlayMode()Z
    ...
    invoke-virtual {v1}, Landroid/view/Display;->getDsdrStatus()I
    ...
    invoke-virtual {v1, v2}, Landroid/view/Display;->hasExternalChildWindow(Landroid/os/IBinder;)Z
    ...
    .line 5362
    .local v0, dlgLp:Landroid/view/WindowManager$LayoutParams;
    ...
    .line 5371
    .end local v0           #dlgLp:Landroid/view/WindowManager$LayoutParams;
    :cond_2
    const-string v1, "Activity"

    const-string v2, "[DSDR] performPause() - mDsdrDlg.show()"
    ...
    invoke-virtual {v1}, Landroid/app/FragmentManagerImpl;->dispatchPause()V
