...
.method private static checkTopOverlayActivity(Ljava/lang/String;)Z
    .locals 7
    ...
    const-string v6, "checkTopOverlayActivity : topActivityName = "
    ...
    const-string v5, "checkTopOverlayActivity : activityName equals with topOverlayActivity"
...
.method private handleBindApplication(Landroid/app/ActivityThread$AppBindData;)V
    ...
    .line 4111
    sget-boolean v2, Lcom/lge/config/ConfigBuildFlags;->CAPP_FONTS_JP:Z

    if-eqz v2, :cond_7

    .line 4112
    invoke-virtual/range {p0 .. p0}, Landroid/app/ActivityThread;->updateFallbackConfigurationLocked()V
...
.method private static performConfigurationChanged(Landroid/content/ComponentCallbacks2;Landroid/content/res/Configuration;)V
    ...
    invoke-static {v3}, Landroid/app/ActivityThread;->checkTopOverlayActivity(Ljava/lang/String;)Z
...
.method private performStopActivityInner(Landroid/app/ActivityThread$ActivityClientRecord;Landroid/app/ActivityThread$StopInfo;ZZ)V
    ...
    invoke-virtual {v1, v4}, Landroid/os/Bundle;->setAllowFds(Z)Z
    ...
    invoke-static {v2}, Landroid/app/ActivityThread;->checkTopOverlayActivity(Ljava/lang/String;)Z
...
.method private updateVisibility(Landroid/app/ActivityThread$ActivityClientRecord;Z)V
    ...
    .line 3050
    sget-boolean v1, Lcom/lge/config/ConfigBuildFlags;->CAPP_FONTS_JP:Z
    ...
    invoke-virtual {p0, v1}, Landroid/app/ActivityThread;->updateFallbackConfigurationIfNeeded(I)V
...
.method final applyConfigurationToResourcesLocked(Landroid/content/res/Configuration;Landroid/content/res/CompatibilityInfo;)Z
    ...
    .line 3713
    iget-object v2, p0, Landroid/app/ActivityThread;->mResConfiguration:Landroid/content/res/Configuration;
    ...
    iput-object v2, p0, Landroid/app/ActivityThread;->mResConfiguration:Landroid/content/res/Configuration;
    ...
    invoke-virtual {p0, v2, v9}, Landroid/app/ActivityThread;->getDisplayMetricsLocked(Landroid/content/res/CompatibilityInfo;Z)Landroid/util/DisplayMetrics;
    ...
    iget-object v2, p0, Landroid/app/ActivityThread;->mResCompatibilityInfo:Landroid/content/res/CompatibilityInfo;

    if-eqz v2, :cond_2

    iget-object v2, p0, Landroid/app/ActivityThread;->mResCompatibilityInfo:Landroid/content/res/CompatibilityInfo;

    invoke-virtual {v2, p2}, Landroid/content/res/CompatibilityInfo;->equals(Ljava/lang/Object;)Z
    ...
    .line 3737
    :cond_4
    invoke-static {p1, v4, p2}, Landroid/content/res/Resources;->updateSystemConfiguration(Landroid/content/res/Configuration;Landroid/util/DisplayMetrics;Landroid/content/res/CompatibilityInfo;)V

    .line 3738
    iget-boolean v2, p0, Landroid/app/ActivityThread;->mThemeIconEnabled:Z

    if-eqz v2, :cond_5

    .line 3739
    invoke-static {p1, v4, p2}, Landroid/content/thm/ThemeIconManager;->updateThemeConfiguration(Landroid/content/res/Configuration;Landroid/util/DisplayMetrics;Landroid/content/res/CompatibilityInfo;)V
    ...
    .line 3749
    .local v7, it:Ljava/util/Iterator;,"Ljava/util/Iterator<Ljava/lang/ref/WeakReference<Landroid/content/res/Resources;>;>;"
    :cond_6
    :goto_1
    ...
    .line 3751
    .local v8, v:Ljava/lang/ref/WeakReference;,"Ljava/lang/ref/WeakReference<Landroid/content/res/Resources;>;"
    invoke-virtual {v8}, Ljava/lang/ref/WeakReference;->get()Ljava/lang/Object;
    ...
    .line 3755
    invoke-virtual {v1, p1, v4, p2}, Landroid/content/res/Resources;->updateConfiguration(Landroid/content/res/Configuration;Landroid/util/DisplayMetrics;Landroid/content/res/CompatibilityInfo;)V

    .line 3759
    invoke-virtual {v1}, Landroid/content/res/Resources;->getThemeIconManager()Landroid/content/thm/ThemeIconManager;

    move-result-object v0

    .line 3760
    .local v0, tm:Landroid/content/thm/ThemeIconManager;
    if-eqz v0, :cond_6
    ...
    invoke-virtual/range {v0 .. v5}, Landroid/content/thm/ThemeIconManager;->updateConfiguration(Landroid/content/res/Resources;ZLandroid/content/res/Configuration;Landroid/util/DisplayMetrics;Landroid/content/res/CompatibilityInfo;)V
    ...
    .line 3768
    .end local v0           #tm:Landroid/content/thm/ThemeIconManager;
    :cond_8
    ...
    .end local v8           #v:Ljava/lang/ref/WeakReference;,"Ljava/lang/ref/WeakReference<Landroid/content/res/Resources;>;"
    :cond_9
    if-eqz v6, :cond_a
...
.method getTopLevelResources(Ljava/lang/String;Landroid/content/res/CompatibilityInfo;)Landroid/content/res/Resources;
    ...
    :cond_4
    :try_start_3
    iget-boolean v6, p0, Landroid/app/ActivityThread;->mThemeIconEnabled:Z

    if-eqz v6, :cond_5

    .line 1618
    new-instance v6, Landroid/content/thm/ThemeIconManager;

    invoke-direct {v6, v4}, Landroid/content/thm/ThemeIconManager;-><init>(Landroid/content/res/Resources;)V

    invoke-virtual {v4, v6}, Landroid/content/res/Resources;->setThemeIconManager(Landroid/content/thm/ThemeIconManager;)V
...
.method final handleConfigurationChanged(Landroid/content/res/Configuration;Landroid/content/res/CompatibilityInfo;)V
    ...
    .line 3829
    sget-boolean v4, Lcom/lge/config/ConfigBuildFlags;->CAPP_FONTS_JP:Z

    if-eqz v4, :cond_6

    .line 3830
    invoke-virtual {p0, v2}, Landroid/app/ActivityThread;->updateFallbackConfigurationIfNeeded(I)V
...
.method final handleResumeActivity(Landroid/os/IBinder;ZZ)V
    ...
    .line 2695
    sget-boolean v9, Lcom/lge/config/ConfigBuildFlags;->CAPP_FONTS:Z
    ...
    invoke-virtual {p0, v9}, Landroid/app/ActivityThread;->updateFontConfigurationIfNeeded(I)V

    .line 2698
    sget-boolean v9, Lcom/lge/config/ConfigBuildFlags;->CAPP_FONTS_JP:Z
    ...
    invoke-virtual {p0, v9}, Landroid/app/ActivityThread;->updateFallbackConfigurationIfNeeded(I)V
...
.method final performPauseActivity(Landroid/app/ActivityThread$ActivityClientRecord;ZZ)Landroid/os/Bundle;
    ...
    invoke-static {v6}, Landroid/app/ActivityThread;->checkTopOverlayActivity(Ljava/lang/String;)Z
...
.method final updateFallbackConfigurationIfNeeded(I)V
    .locals 1
    .parameter "configDiff"
    ...
    .line 4955
    invoke-virtual {p0}, Landroid/app/ActivityThread;->updateFallbackConfigurationLocked()V
...
.method final updateFallbackConfigurationLocked()V
    .locals 0

    .prologue
    .line 4962
    invoke-static {}, Landroid/graphics/Typeface;->updateFallbackConfiguration()V
