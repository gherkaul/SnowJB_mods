...
.method startExtractingText(Z)V
    ...
    iget v5, v5, Landroid/view/inputmethod/ExtractedText;->flags:I
    ...
    :goto_1
    invoke-virtual {v0, v5}, Landroid/inputmethodservice/ExtractEditText;->setIsHandleShowing(Z)V
    ...
    :goto_2
    invoke-virtual {v0, v5}, Landroid/inputmethodservice/ExtractEditText;->setCanEnterActionMode(Z)V
    ...
    :goto_3
    invoke-virtual {v0, v5}, Landroid/inputmethodservice/ExtractEditText;->setAddToDic(Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public updateFullscreenMode()V
    ...
    :goto_0
    iget-boolean v8, p0, Landroid/inputmethodservice/InputMethodService;->mLastShowInputRequested:Z

    iget-boolean v11, p0, Landroid/inputmethodservice/InputMethodService;->mShowInputRequested:Z
    ...
    .line 857
    .local v6, updateExtractUi:Z
    :goto_3
    iget-boolean v8, p0, Landroid/inputmethodservice/InputMethodService;->mIsFullscreen:Z

    if-ne v8, v4, :cond_1

    iget-boolean v8, p0, Landroid/inputmethodservice/InputMethodService;->mFullscreenApplied:Z
    ...
    .line 859
    iput-boolean v4, p0, Landroid/inputmethodservice/InputMethodService;->mIsFullscreen:Z
    ...
    .line 862
    :cond_2
    iput-boolean v9, p0, Landroid/inputmethodservice/InputMethodService;->mFullscreenApplied:Z
    ...
    iget-object v11, p0, Landroid/inputmethodservice/InputMethodService;->mThemeAttrs:Landroid/content/res/TypedArray;

    invoke-virtual {v11, v10}, Landroid/content/res/TypedArray;->getDrawable(I)Landroid/graphics/drawable/Drawable;

    move-result-object v11

    invoke-virtual {v8, v11}, Landroid/view/ViewGroup;->setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object v11, p0, Landroid/inputmethodservice/InputMethodService;->mFullscreenArea:Landroid/view/ViewGroup;

    invoke-virtual {v8, v11, v5}, Landroid/view/ViewGroup;->updateViewLayout(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    .line 882
    invoke-virtual {p0, v10}, Landroid/inputmethodservice/InputMethodService;->setExtractViewShown(Z)V
    ...
    :cond_4
    invoke-virtual {p0, v10}, Landroid/inputmethodservice/InputMethodService;->startExtractingText(Z)V
    ...
    .line 896
    iget-object v8, p0, Landroid/inputmethodservice/InputMethodService;->mWindow:Landroid/inputmethodservice/SoftInputWindow;

    invoke-virtual {v8}, Landroid/inputmethodservice/SoftInputWindow;->getWindow()Landroid/view/Window;
    ...
    :goto_5
    invoke-virtual {p0, v8, v4, v9}, Landroid/inputmethodservice/InputMethodService;->onConfigureWindow(Landroid/view/Window;ZZ)V

    .line 897
    iget-boolean v8, p0, Landroid/inputmethodservice/InputMethodService;->mShowInputRequested:Z

    iput-boolean v8, p0, Landroid/inputmethodservice/InputMethodService;->mLastShowInputRequested:Z
    ...
    .end local v1           #ei:Landroid/view/inputmethod/EditorInfo;
    .end local v2           #hideExtractUi:Z
    .end local v4           #isFullscreen:Z
    .end local v6           #updateExtractUi:Z
    :cond_8
    move v4, v10
    ...
    .restart local v4       #isFullscreen:Z
    :cond_9
    move v0, v10
    ...
    .restart local v2       #hideExtractUi:Z
    :cond_b
    move v6, v10
    ...
    .restart local v6       #updateExtractUi:Z
    :cond_c
    iget-object v8, p0, Landroid/inputmethodservice/InputMethodService;->mFullscreenArea:Landroid/view/ViewGroup;
