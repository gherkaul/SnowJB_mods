...
.method private static processDrmObject(Landroid/content/Context;Ljava/lang/String;[B)[B
    ...
    const-string v14, "createObjectSession() : Fail"
    ...
    invoke-static {v13, v0}, Lcom/lge/lgdrm/DrmManager;->createObjectSession(ILandroid/content/Context;)Lcom/lge/lgdrm/DrmObjectSession;

    move-result-object v12

    .line 2220
    .local v12, session:Lcom/lge/lgdrm/DrmObjectSession;
    if-nez v12, :cond_2
    ...
    invoke-virtual {v12, v0, v5, v13}, Lcom/lge/lgdrm/DrmObjectSession;->processInit(Ljava/lang/String;Ljava/lang/String;I)I
    ...
    const-string/jumbo v14, "processInit() : Fail"
    ...
    invoke-virtual {v12, v13}, Lcom/lge/lgdrm/DrmObjectSession;->destroySession(I)V
    ...
    invoke-virtual {v12, v0, v13}, Lcom/lge/lgdrm/DrmObjectSession;->processUpdate([BI)I
    ...
    const-string/jumbo v15, "session.processUpdate: Data Length"
    ...
    const-string/jumbo v15, "session.processUpdate:"
    ...
    const-string/jumbo v14, "processUpdate() : Fail"
    ...
    invoke-virtual {v12}, Lcom/lge/lgdrm/DrmObjectSession;->processStatus()I
    ...
    const-string/jumbo v14, "processStatus() : Fail"
    ...
    invoke-virtual {v12, v14, v15}, Lcom/lge/lgdrm/DrmObjectSession;->processEnd(ILandroid/content/ComponentName;)I
    ...
    const-string/jumbo v14, "processEnd() : Fail"
    ...
    .line 2259
    :cond_6
    invoke-virtual {v12}, Lcom/lge/lgdrm/DrmObjectSession;->getStoredFilename()Ljava/lang/String;
    ...
    const-string v15, "getStoredFilename() : file name = "
    ...
    const-string v14, "here is outfileName"
    ...
    const-string/jumbo v15, "outfileName"
...
.method protected parseHeaders(Ljava/io/ByteArrayInputStream;)Lcom/google/android/mms/pdu/PduHeaders;
    ...
    .line 872
    :pswitch_0
    const-string v34, "Unknown header"
    ...
    const-string v35, "Set invalid Octet value: "
    ...
    const-string v35, " into the header filed: "
    ...
    const-string v35, "is not Octet header field!"
    ...
    const-string v35, "is not Long-Integer header field!"
    ...
    const-string v35, "is not Text-String header field!"
    ...
    .line 448
    .local v31, value:Lcom/google/android/mms/pdu/EncodedStringValue;
    const/16 v34, 0x0
    ...
    .line 451
    sget-boolean v34, Lcom/google/android/mms/pdu/PduParser;->$assertionsDisabled:Z
    ...
    .end local v31           #value:Lcom/google/android/mms/pdu/EncodedStringValue;
    move-object/from16 v0, v31

    invoke-direct {v0, v4}, Lcom/google/android/mms/pdu/EncodedStringValue;-><init>([B)V

    .line 493
    .end local v9           #first:I
    .end local v14           #i:I
    .end local v27           #temp1:I
    .restart local v31       #value:Lcom/google/android/mms/pdu/EncodedStringValue;
    :cond_9
    :goto_4
    if-nez v15, :cond_a
    ...
    .line 476
    const-string v34, "PDUPARSER"

    const-string v35, "Exception while parsing Base64 string"
    ...
    const-string v35, "is not Encoded-String-Value header field!"
    ...
    .line 522
    invoke-virtual/range {v31 .. v31}, Lcom/google/android/mms/pdu/EncodedStringValue;->getTextString()[B
    ...
    .line 527
    sget-object v34, Lcom/google/android/mms/ContentType;->OPERATOR_CODE:Ljava/lang/String;

    const-string v35, "MPCS"
    ...
    sget-object v34, Lcom/google/android/mms/ContentType;->COUNTRY_CODE:Ljava/lang/String;
    ...
    const-string v34, "insert-address-token"
    ...
    .line 679
    :try_start_f
    const-string v34, "advertisement"
    ...
    .line 683
    :try_start_10
    const-string v34, "informational"
    ...
    .line 701
    .local v19, messageClassString:[B
    if-eqz v19, :cond_2
    ...
    .line 716
    .end local v7           #e:Ljava/lang/RuntimeException;
    .end local v18           #messageClass:I
    .end local v19           #messageClassString:[B
    :pswitch_c
    ...
    .line 748
    .local v24, previouslySentBy:Lcom/google/android/mms/pdu/EncodedStringValue;
    if-eqz v24, :cond_2
    ...
    .line 740
    .end local v7           #e:Ljava/lang/NullPointerException;
    .end local v24           #previouslySentBy:Lcom/google/android/mms/pdu/EncodedStringValue;
    :catch_1b
    move-exception v7
    ...
    const-string v35, " is not Integer-Value"
    ...
    .line 754
    .end local v7           #e:Ljava/lang/RuntimeException;
    .restart local v24       #previouslySentBy:Lcom/google/android/mms/pdu/EncodedStringValue;
    :catch_1c
    move-exception v7
    ...
    .line 779
    .local v22, perviouslySentDate:J
    const/16 v34, 0xa1
    ...
    .line 781
    .end local v22           #perviouslySentDate:J
    :catch_1d
    move-exception v7
    ...
    .line 844
    .local v17, map:Ljava/util/HashMap;,"Ljava/util/HashMap<Ljava/lang/Integer;Ljava/lang/Object;>;"
    move-object/from16 v0, p1
